...
5. [`vision.md`](vision.md) — scope and non-goals.
6. [`architecture.md`](architecture.md) — system boundaries.
7. [`security/threat-model.md`](security/threat-model.md) — threat model.
8. [`security/trust-boundaries.md`](security/trust-boundaries.md) — authority/data boundaries.
9. [`security/authentication-and-sessions.md`](security/authentication-and-sessions.md) — implemented human/agent auth and CSRF contract.
